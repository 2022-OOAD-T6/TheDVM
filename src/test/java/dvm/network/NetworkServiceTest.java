...
class NetworkServiceTest {
    ...
    @Test
    void getSaleResponseMessage() throws InterruptedException {
    ...
    @Test
    void getStockResponseMessageFrom() throws InterruptedException {
        ...
        Thread.sleep(1000);
        Message message = networkService.getStockResponseMessageFrom("Team3");
